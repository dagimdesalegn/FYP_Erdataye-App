...
const styles = StyleSheet.create({
  ...
  statLabel: { fontSize: 13, fontWeight: '600', fontFamily: Fonts.sans, textAlign: 'center' },
  ...
  badgeText: { fontSize: 12, fontWeight: '800', fontFamily: Fonts.sans, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  dropdownSignOut: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 12 },
